...
x_cor_device_entry.insert(0, '0.0000')
...
y_cor_device_entry.insert(0, '0.0000')
...
z_cor_device_entry.insert(0, '0.0000')
...
doz_cor_device_entry.insert(0, '0.0000')
...
x_cor_system_entry.insert(0, '0.0000')
...
y_cor_system_entry.insert(0, '0.0000')
...
z_cor_system_entry.insert(0, '0.0000')
...
doz_cor_system_entry.insert(0, '0.0000')
...
class SystemCorVal():
    ...
    def increase_value(self):
        fl_val = Decimal('0.0001')
        self.coordinate_obj += fl_val
...
go_sock = socket.socket()
go_sock.connect(('localhost', 6160))
